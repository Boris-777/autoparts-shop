document.addEventListener("DOMContentLoaded", () => {
    ...
    const translations = {
        ...
        ka: {
            ...
            wideRange: 'ყველა მარკის მანქანის ნაწილების ფართო არჩევანი',
            goToCatalog: 'კატალოგში გადასვლა',
            productCategories: 'პროდუქტის კატეგორიები',
            productCatalog: 'პროდუქტის კატალოგი',
        ...
        hy: {
            ...
            qualityParts: 'Որակյալ ավտոմեքենայի մասեր',
            wideRange: 'Բոլոր մակնիշների մեքենաների մասերի լայն տեսականի',
            goToCatalog: 'Գնալ կատալոգ',
            productCategories: 'Ապրանքի կատեգորիաներ',
            productCatalog: 'Ապրանքի կատալոգ',
